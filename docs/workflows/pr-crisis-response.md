# Workflow: PR Crisis Response

**From incident to controlled narrative — 6 skills under time pressure.**

This workflow covers rapid crisis communications when something goes wrong and you need to respond fast. Each step is designed to be executed quickly and in sequence.

---

## Who This Is For

PR professionals, communications directors, and press officers managing a crisis for an organization — whether it's a product failure, executive misconduct, data breach, public backlash, or operational incident.
...
**Output you'll use next:** Issue immediately to any journalists who are already asking questions.

**Time:** Do this within the first hour.
...
**Output you'll use next:** Publish on your website and distribute to media.
...
**Output you'll use next:** Internal reference for anyone fielding calls, and public FAQ for your website.
...
**Output you'll use next:** Hand to your spokesperson before any media appearance.
...
**Output you'll use next:** Send to your priority media list.
...
**Output you'll use next:** Send 48–72 hours after the initial statement.
...
- **Speed matters more than perfection in Step 1.** A holding statement that goes out in 30 minutes is worth more than a perfect statement that takes 4 hours.
- **Never speculate in any crisis communication.** If you don't know something, say "We are investigating" — not "We believe."
- **Run Step 3 (FAQ) even if you don't publish it.** The act of anticipating questions reveals gaps in your response.
- **Brief your spokesperson (Step 4) before they talk to anyone.** Unprepped spokespeople create new crises.
