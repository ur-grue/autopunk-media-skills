# Workflow: Podcast Season Launch

**From season concept to episode one — 9 skills in order.**

This workflow takes you from a blank page to a fully planned, scripted, and published first episode, with a season arc ready to go.

---

## Who This Is For

Podcast producers and hosts launching a new show or a new season. Works for interview shows, narrative podcasts, solo episodes, and panel formats.
...
**Output you'll use next:** Your season outline — pick and sequence the episodes.
...
**Output you'll use next:** Foundation for your interview questions.
...
**Output you'll use next:** Your recording cue sheet.
...
**Output you'll use next:** Your recording script bookends.
...
**Output you'll use next:** Integrate into your recording script at the right break point.

---

### Step 6: Record the episode
*No skill needed — this is where you do the work.*
...
**Output you'll use next:** Foundation for show notes and episode summary.
...
**Output you'll use next:** Paste into your podcast host.
...
**Output you'll use next:** Publish with your episode.
