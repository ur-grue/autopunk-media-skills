# Workflow: YouTube Video Launch

**From idea to published video — 8 skills in order.**

This workflow walks you through every step of planning, scripting, and publishing a YouTube video using skills from the library. Follow them in sequence. Each step's output feeds into the next.

---

## Who This Is For

YouTube creators working on scripted or semi-scripted content (explainers, essays, educational, commentary). Works for both solo creators and small teams.
...
**Output you'll use next:** Pick your strongest concept and its core angle.
...
**Output you'll use next:** Your working title (you can refine it later).
...
**Output you'll use next:** Save this for your designer or your own Canva/Photoshop session.
...
**Output you'll use next:** Your chosen hook becomes the opening of your full script.
...
**Output you'll use next:** Your shooting/recording script.
...
**Output you'll use next:** Your production checklist.
...
**Output you'll use next:** Paste directly into YouTube.
...
**Output you'll use next:** Add to your description from Step 7.
