# Workflow: Newsletter From Scratch

**From blank page to paying subscribers — 8 skills in order.**

This workflow covers launching a newsletter from initial positioning through to your first paid tier, with a content strategy that builds an audience systematically.

---

## Who This Is For

Writers, journalists, and subject-matter experts launching a newsletter on platforms like Substack, Beehiiv, Ghost, or ConvertKit. Works for solo operators and small editorial teams.
...
**Output you'll use next:** Your editorial identity. Everything else flows from this.
...
**Output you'll use next:** Your editorial calendar for the first 8–12 weeks.
...
**Output you'll use next:** Paste into your newsletter platform's sign-up page.
...
**Output you'll use next:** Set as your automated welcome sequence.
...
**Output you'll use next:** Publish.
...
**Output you'll use next:** Pick the strongest and send.
...
**Output you'll use next:** Add to your referral program or share prompts.
...
**Output you'll use next:** Your paywall messaging.
