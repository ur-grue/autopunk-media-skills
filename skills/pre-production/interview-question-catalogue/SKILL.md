...
description: "Generate a structured catalogue of interview questions for a specific subject and topic — organised by theme and sequenced from rapport-building openers to probing follow-ups."
status: stable
...
- [guest-research-brief](../../podcast/pre-production/guest-research-brief/SKILL.md)
- [biography-researcher](../../research/people-contacts/biography-researcher/SKILL.md)
- [tailored-interview-questions](../tailored-interview-questions/SKILL.md)
