...
description: "Generates two distinct social media post variants for the same content — each using a different hook strategy, tone, or call to action — with a clear hypothesis for what each variant tests, ready for split-testing on any platform."
status: stable
...
## Related Skills
- [caption-writer](../../content/caption-writer/SKILL.md) — write the baseline post before generating test variants
- [tag-keyword-generator](../tag-keyword-generator/SKILL.md) — optimize tags alongside the post copy
- [hashtag-strategy-writer](../hashtag-strategy-writer/SKILL.md) — test hashtag strategies as a separate variable
- [platform-strategy-brief](../platform-strategy-brief/SKILL.md) — build a broader testing program across platforms
