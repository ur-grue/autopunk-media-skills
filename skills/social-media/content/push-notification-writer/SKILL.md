...
description: "Writes three push notification variants for a news story or content update, each optimized for different urgency levels and character limits, ready to paste directly into a CMS or notification platform."
status: stable
...
## Related Skills
- [caption-writer](../caption-writer/SKILL.md) — write social media captions to accompany the same story
- [seo-meta-description-writer](../seo-meta-description-writer/SKILL.md) — write the meta description for the article the notification links to
- [ab-social-post-tester](../../strategy/ab-social-post-tester/SKILL.md) — generate A/B test variants for the social promotion of the same story
