...
description: "Builds a complete radio programme running order with timed segments, item slugs, durations, presenter notes, and transition guidance from a list of planned content."
status: stable
...
## Related Skills
- [programme-brief-writer](../programme-brief-writer/SKILL.md)
- [bulletin-script-writer](../../scripting/bulletin-script-writer/SKILL.md)
- [presenter-link-writer](../../scripting/presenter-link-writer/SKILL.md)
