...
description: "Writes a structured internal radio programme brief covering format, audience, tone, regular features, editorial aims, and production requirements for a new or relaunching show."
status: stable
...
## Related Skills
- [pitch-to-broadcaster](../../strategy/pitch-to-broadcaster/SKILL.md)
- [running-order-builder](../running-order-builder/SKILL.md)
- [documentary-narration-writer](../../scripting/documentary-narration-writer/SKILL.md)
