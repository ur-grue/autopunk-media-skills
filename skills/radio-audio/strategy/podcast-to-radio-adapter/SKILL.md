...
description: "Adapts a podcast episode or series format for broadcast radio, identifying and resolving the structural, editorial, and regulatory differences between on-demand and live scheduled audio."
status: stable
...
## Related Skills
- [pitch-to-broadcaster](../pitch-to-broadcaster/SKILL.md)
- [programme-brief-writer](../../production/programme-brief-writer/SKILL.md)
- [running-order-builder](../../production/running-order-builder/SKILL.md)
