...
description: "Produces a formatted radio interview cue sheet with scripted intro, key questions, suggested follow-ups, factual reference points, and a clean out-cue for the presenter."
status: stable
...
## Related Skills
- [two-way-brief-writer](../../news-packages/two-way-brief-writer/SKILL.md)
- [presenter-link-writer](../presenter-link-writer/SKILL.md)
- [package-script-writer](../../news-packages/package-script-writer/SKILL.md)
