...
description: "Writes a reporter stand-up script — a piece to camera or piece to microphone delivered on location — with positioning notes, delivery guidance, and integration cues for the surrounding package, ready for a broadcast journalist to rehearse and record."
status: stable
...
3. **Matches the word count to the target duration.** Broadcast stand-ups follow strict timing: approximately 3 words per second (180 words per minute) for a measured delivery, slightly faster for hard news. A 20-second stand-up is 55–65 words. A 30-second stand-up is 80–95 words. The assistant writes to these counts precisely — every word earns its place.
...
## Related Skills
- [bulletin-script-writer](../bulletin-script-writer/SKILL.md) — write the studio-read copy that introduces or follows the stand-up's package
- [package-script-writer](../../news-packages/package-script-writer/SKILL.md) — write the full news package script that the stand-up sits within
- [presenter-link-writer](../presenter-link-writer/SKILL.md) — write the presenter's studio link that throws to the reporter on location
