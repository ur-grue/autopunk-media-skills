...
description: "Creates a glossary of key terms for a specific topic or article, with concise plain-language definitions formatted for publication as a sidebar, companion box, or standalone reference."
status: stable
...
## Related Skills
- [sidebar-fact-box-writer](../sidebar-fact-box-writer/SKILL.md) — create a fact box to accompany the glossary
- [copy-editor-assistant](../../editing/copy-editor-assistant/SKILL.md) — review definitions for accuracy and consistency with the article
- [article-summary-writer](../article-summary-writer/SKILL.md) — summarize the article the glossary accompanies
- [news-article-writer](../../../writing/articles/news-article-writer/SKILL.md) — write the article that the glossary will support
