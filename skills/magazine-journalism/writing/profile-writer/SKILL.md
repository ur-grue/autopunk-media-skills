---
name: profile-writer
description: "Writes a magazine-style profile piece on a person from interview notes, biographical background, and a stated editorial angle — delivering a polished draft that balances character, narrative, and context."
status: stable
...
- [lede-writer](../../../writing/articles/lede-writer/SKILL.md) — generate alternative opening paragraphs if the profile's opening needs reworking
- [copy-editor-assistant](../../editing/copy-editor-assistant/SKILL.md) — line-edit the finished profile before filing
- [column-voice-adapter](../column-voice-adapter/SKILL.md) — adapt the profile's tone to match a specific publication voice
