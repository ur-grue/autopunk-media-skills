...
description: "Writes a concise summary, standfirst, abstract, or deck for a completed article at a specified length and format — capturing the essential argument and news value without spoiling the reading experience."
status: stable
...
## Related Skills
- [headline-generator](../../ideation/headline-generator/SKILL.md) — write the headline that the standfirst will complement
- [newsletter-teaser-writer](../../distribution/newsletter-teaser-writer/SKILL.md) — dedicated newsletter copy skill with more format options
- [social-media-excerpt](../../distribution/social-media-excerpt/SKILL.md) — adapt article content for social media platforms
- [copy-editor-assistant](../../editing/copy-editor-assistant/SKILL.md) — review the summary for style and accuracy
