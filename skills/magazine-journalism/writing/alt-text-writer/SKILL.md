...
description: "Writes descriptive alt text for editorial images following WCAG accessibility guidelines — concise enough for screen readers, specific enough to convey the image's editorial purpose."
status: stable
...
## Related Skills
- [photo-caption-writer](../../../writing/articles/photo-caption-writer/SKILL.md) — write the visible caption that accompanies the image (alt text and captions serve different purposes and should not duplicate each other)
- [copy-editor-assistant](../../editing/copy-editor-assistant/SKILL.md) — review alt text for consistency and style across a full article
- [sidebar-fact-box-writer](../sidebar-fact-box-writer/SKILL.md) — create extended descriptions for complex data visualizations
