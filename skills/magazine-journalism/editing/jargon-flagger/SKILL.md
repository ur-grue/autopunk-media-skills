---
name: jargon-flagger
description: "Scans a draft and flags every instance of technical jargon, unexplained acronyms, and insider language that a general-audience reader would not understand — with a plain-language alternative for each."
status: stable
...
## Related Skills
- [copy-editor-assistant](../copy-editor-assistant/SKILL.md) — catch grammar and style issues alongside jargon
- [house-style-enforcer](../house-style-enforcer/SKILL.md) — check terminology against a publication's approved vocabulary
- [structure-checker](../structure-checker/SKILL.md) — diagnose clarity problems that go beyond terminology
