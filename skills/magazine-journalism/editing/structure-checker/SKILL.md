...
description: "Analyses a draft article's structural architecture — paragraph order, logical flow, redundancies, and pacing — and returns a diagnostic report with specific reordering, cutting, or restructuring recommendations."
status: stable
...
## Related Skills
- [copy-editor-assistant](../copy-editor-assistant/SKILL.md) — line-level editing after structural issues are resolved
- [text-condenser](../text-condenser/SKILL.md) — cut the piece after restructuring identifies redundant passages
- [text-expander](../text-expander/SKILL.md) — expand sections flagged as underdeveloped in the structural analysis
