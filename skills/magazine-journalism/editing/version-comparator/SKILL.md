...
description: "Compares two versions of an article and produces a structured change report — highlighting substantive edits, additions, deletions, and tone shifts — so the editor or writer can quickly understand what changed and assess whether the revisions improved the piece."
status: stable
...
## Related Skills
- [copy-editor-assistant](../copy-editor-assistant/SKILL.md) — run a copy edit on the final version after reviewing the comparison
- [structure-checker](../structure-checker/SKILL.md) — verify the revised version's structural logic independently
- [multi-author-harmonizer](../multi-author-harmonizer/SKILL.md) — if different versions were written by different people, harmonise the final version's voice
