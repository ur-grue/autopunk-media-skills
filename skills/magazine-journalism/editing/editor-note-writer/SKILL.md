...
description: "Drafts a publication-ready editor's note — correction, clarification, update, or disclosure — from the facts you provide, following standard editorial transparency conventions."
status: stable
...
## Related Skills
- [copy-editor-assistant](../copy-editor-assistant/SKILL.md) — catch errors before publication to reduce the need for corrections
- [fact-check-prompt](../fact-check-prompt/SKILL.md) — verify claims in the draft before it goes live
- [house-style-enforcer](../house-style-enforcer/SKILL.md) — ensure the note matches your publication's formatting standards
