---
name: text-condenser
description: "Cuts an article or passage to a target word count by removing redundancies, tightening prose, and eliminating low-value sentences — while preserving the piece's key information, structure, and voice."
status: stable
...
## Related Skills
- [text-expander](../text-expander/SKILL.md) — the inverse operation: expand a short passage to a target word count
- [structure-checker](../structure-checker/SKILL.md) — assess the article's architecture before deciding what to cut
- [copy-editor-assistant](../copy-editor-assistant/SKILL.md) — run a copy edit after condensing to catch any issues introduced by the cuts
