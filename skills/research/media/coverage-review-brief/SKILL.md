...
description: "Produces a structured framework for reviewing how a topic has been covered by other media outlets — identifying the dominant narrative frames, the sources quoted, the angles explored, and the gaps in coverage — so a journalist can find the untold story and avoid repeating what has already been reported."
status: stable
category: research
subcategory: media
version: 1.0
...
## Related Skills
- [press-roundup-writer](../press-roundup-writer/SKILL.md) — write a formatted press roundup summarising the coverage you found
- [debate-state-summary](../../background/debate-state-summary/SKILL.md) — summarise the broader debate the coverage relates to
- [person-biography-brief](../../people/person-biography-brief/SKILL.md) — research the key sources quoted in the coverage
- [historical-precedent-finder](../../background/historical-precedent-finder/SKILL.md) — find historical precedents for the policy being covered
