...
description: "Produces a structured summary of how other outlets have already covered a given topic, so you can enter any story with a clear picture of the existing media landscape."
status: stable
category: research
...
**Optional:** A date range to limit the review. Any specific sub-angles you want tracked. The format your outlet publishes in (print, digital, broadcast) — this helps the assistant flag the most relevant competitor formats.
...
## Known Limitations
- The assistant cannot retrieve live articles or real-time data. This brief is most accurate when you paste in actual article text, headlines, or detailed notes from your own reading — treating the assistant as an analyst rather than a researcher. If you provide only outlet names and a topic, the output reflects the assistant's training data, which has a knowledge cutoff and may miss recent developments.
- For niche trade publications or regional outlets with limited online presence, the assistant's knowledge will be thinner. Supplement with your own desk research for these.
...
## Related Skills
- [coverage-gap-identifier](../coverage-gap-identifier/SKILL.md)
- [competitor-framing-analyzer](../competitor-framing-analyzer/SKILL.md)
- [research-brief-creator](../../../magazine-journalism/ideation/research-brief-creator/SKILL.md)
