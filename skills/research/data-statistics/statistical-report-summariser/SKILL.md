...
description: "Translates the key findings of a statistical report into plain, journalist-ready language — pulling out the numbers that matter, explaining what they mean, and flagging anything that needs verification before publication."
status: stable
category: research
...
- [public-database-guide](../public-database-guide/SKILL.md)
- [official-data-finder](../official-data-finder/SKILL.md)
- [dataset-summary-brief](../../../data-journalism/analysis/dataset-summary-brief/SKILL.md)
- [statistics-explainer](../../../data-journalism/analysis/statistics-explainer/SKILL.md)
