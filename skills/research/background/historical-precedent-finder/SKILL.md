...
description: "Identifies historical precedents relevant to a current news event or policy debate, provides a structured comparison showing why each precedent is or is not analogous, and lists the sources a journalist should consult to verify and deepen each comparison."
status: stable
category: research
...
## Related Skills
- [debate-state-summary](../debate-state-summary/SKILL.md) — summarise the current state of the debate the precedent informs
- [legislative-history-brief](../legislative-history-brief/SKILL.md) — trace the legislative history of any policy cited as precedent
- [scientific-consensus-brief](../../academic/scientific-consensus-brief/SKILL.md) — assess the academic consensus on the effectiveness of interventions cited
- [jargon-translator](../../academic/jargon-translator/SKILL.md) — translate academic language in the source materials into plain English
