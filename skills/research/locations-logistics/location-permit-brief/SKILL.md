...
description: "Produces a structured brief summarising the permit requirements, access restrictions, and key contacts needed to film or photograph at a specific location."
status: stable
category: research
...
- [travel-logistics-brief](../../logistics/travel-logistics-brief/SKILL.md)
- [interview-location-researcher](../interview-location-researcher/SKILL.md)
- [shoot-equipment-list](../shoot-equipment-list/SKILL.md)
