...
description: "Writes \"read next,\" \"related articles,\" or \"previously on\" teaser blocks for web pages, newsletters, or app interfaces — short, click-worthy summaries that drive readers from one piece of content to another."
status: stable
...
## Related Skills
- [cms-metadata-writer](../../formatting/cms-metadata-writer/SKILL.md) — write the metadata for the articles these teasers link to
- [web-section-splitter](../../formatting/web-section-splitter/SKILL.md) — structure the host article that contains the teaser block
- [newsletter-teaser-writer](../../../magazine-journalism/distribution/newsletter-teaser-writer/SKILL.md) — write teasers specifically formatted for email newsletters
- [fact-sheet-compiler](../fact-sheet-compiler/SKILL.md) — compile background reference material for a content series
