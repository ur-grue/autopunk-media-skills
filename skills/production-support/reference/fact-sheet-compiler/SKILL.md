...
description: "Compiles a structured, scannable fact sheet on a topic — organizing key data, definitions, timelines, and context into a single reference document for editorial teams, producers, or journalists working on a story."
status: stable
...
## Related Skills
- [research-brief-creator](../../../magazine-journalism/ideation/research-brief-creator/SKILL.md) — create a research brief to guide reporting on the topic
- [teaser-block-writer](../teaser-block-writer/SKILL.md) — write teasers linking to articles that draw on this fact sheet
- [cms-metadata-writer](../../formatting/cms-metadata-writer/SKILL.md) — write metadata for articles published from this research
- [interview-question-builder](../../../podcast/pre-production/interview-question-builder/SKILL.md) — build interview questions informed by the fact sheet
