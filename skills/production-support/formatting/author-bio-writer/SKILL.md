...
description: "Writes a concise, publication-ready author bio in the appropriate register and length for the target outlet — from a one-line byline tag to a full contributor page paragraph."
status: stable
