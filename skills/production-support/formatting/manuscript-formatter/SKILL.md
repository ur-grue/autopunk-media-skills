...
description: "Reformats a manuscript, article, or long-form text to match a specific publication's structural and style requirements — adjusting headings, paragraph spacing, citation format, pull-quote placement, and front matter without altering the content itself."
status: stable
...
- [web-section-splitter](../web-section-splitter/SKILL.md) — split a formatted article into web-optimized sections
- [cms-metadata-writer](../cms-metadata-writer/SKILL.md) — write CMS metadata for the formatted article before publishing
- [author-bio-writer](../author-bio-writer/SKILL.md) — write the author bio to accompany the formatted submission
