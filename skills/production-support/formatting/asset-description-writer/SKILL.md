...
description: "Writes structured, searchable descriptions for digital assets — photos, videos, audio files, graphics, and documents — enabling accurate retrieval from a digital asset management (DAM) system or media archive."
status: stable
...
## Related Skills
- [cms-metadata-writer](../cms-metadata-writer/SKILL.md) — write web publishing metadata (SEO, social sharing fields)
- [fact-sheet-compiler](../../reference/fact-sheet-compiler/SKILL.md) — compile reference material about a topic for editorial use
- [press-kit-generator](../../../tv-documentary/post-production/press-kit-generator/SKILL.md) — generate press kit materials that reference archived assets
