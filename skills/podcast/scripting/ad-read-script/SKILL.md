---
name: ad-read-script
description: "Turns a brand brief into a host-read ad script that fits the show's tone, meets sponsor requirements, and sounds spoken — not read."
status: stable
category: podcast
...
## Related Skills
- [sponsorship-pitch-writer](../../business/sponsorship-pitch-writer/SKILL.md)
