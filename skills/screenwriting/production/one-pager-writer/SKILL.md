...
description: "Writes a one-page screenplay sales document — logline, short synopsis, tone references, and writer positioning — formatted for producer meetings, development slates, and financier packets."
status: stable
...
## Related Skills
- [logline-writer](../../development/logline-writer/SKILL.md)
- [treatment-writer](../../development/treatment-writer/SKILL.md)
- [coverage-report-writer](../../revision/coverage-report-writer/SKILL.md)
