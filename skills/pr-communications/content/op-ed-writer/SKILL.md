---
name: op-ed-writer
description: "Writes a bylined opinion article for placement in a newspaper or trade publication, building a thought-leadership argument from a briefing and key messages into a piece that reads as the spokesperson's genuine voice, not a press release in disguise."
status: stable
category: pr-communications
subcategory: content
version: 1.0
eval_score: 4.5
tags: [pr, content, op-ed, thought-leadership, byline]
---
# Op-Ed Writer
...
- You want a senior executive, expert, or spokesperson to build a public profile through published opinion
- A policy change, industry trend, or cultural moment creates an opportunity for your organisation's leader to weigh in publicly
- You have been invited to submit a guest column or comment piece and need a draft within a short deadline
- A crisis or controversy gives your organisation a legitimate platform to explain its position at length
...
4. Acknowledges the strongest counterargument briefly and rebuts it — this is what separates genuine opinion from marketing copy.
5. Closes with a call to action, a challenge, or a restatement of the stakes — not a summary of the preceding paragraphs.
...
## Quality Criteria
- [ ] Piece opens with a concrete hook, not credentials or context-setting
- [ ] Central argument is stated by the end of the second paragraph
- [ ] At least one counterargument is acknowledged and addressed
- [ ] No paragraph contains more than one argument or claim
- [ ] Author's voice is consistent throughout — not formal in one paragraph and casual in the next
- [ ] Piece closes with a forward-looking statement, challenge, or call to action
- [ ] No paragraph that reads like a press release or company announcement
...
Supporting points:
- Independent audits have found that up to 90% of rainforest carbon credits approved by some major certifiers are "phantom credits" with no measurable impact on deforestation
- The offset market grew to $2 billion in 2023 while global emissions rose, not fell
- Companies using offsets to claim carbon neutrality are shielded from the operational changes that actually reduce emissions
...
### Output
**Carbon offsets were never going to save us. It's time to say so.**
*By Dr. Elena Sousa, Director of Climate Research, Vantage Environmental Institute*
...
- [journalist-pitch-email](../../media-relations/journalist-pitch-email/SKILL.md)
