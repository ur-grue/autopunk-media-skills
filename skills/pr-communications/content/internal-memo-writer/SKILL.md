...
description: "Writes a clear, structured internal memo for staff or leadership, translating a communications situation into a concise document with context, key messages, and recommended actions."
status: stable
...
## Related Skills
- [op-ed-writer](../op-ed-writer/SKILL.md) — write an external opinion piece on the same topic
- [speech-writer](../speech-writer/SKILL.md) — prepare remarks for a leadership announcement
- [crisis-statement-writer](../../crisis-comms/crisis-statement-writer/SKILL.md) — write a public-facing crisis statement
- [holding-statement-writer](../../crisis-comms/holding-statement-writer/SKILL.md) — draft a brief holding response while a full statement is prepared
