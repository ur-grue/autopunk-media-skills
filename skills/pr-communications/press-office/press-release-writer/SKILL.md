...
description: "Writes a complete, newswire-ready press release from a briefing note, following inverted-pyramid structure and standard AP/PR-wire conventions."
status: stable
...
- [boilerplate-writer](../boilerplate-writer/SKILL.md)
