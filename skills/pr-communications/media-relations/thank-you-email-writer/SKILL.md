...
description: "Writes a brief, genuine thank-you email to a journalist or media contact after coverage, an interview, or a professional favour, reinforcing the relationship without being transactional."
status: stable
...
- [journalist-pitch-email](../journalist-pitch-email/SKILL.md) — write the original pitch that led to the coverage
- [spokesperson-briefing-note](../spokesperson-briefing-note/SKILL.md) — prepare a spokesperson before a media interview
