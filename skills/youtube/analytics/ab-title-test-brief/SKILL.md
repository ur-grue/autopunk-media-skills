...
description: "Generates 4–5 title variants for A/B testing — each on a different click-psychology principle, with a rationale and a test hypothesis."
status: stable
category: youtube
...
- [performance-report-writer](../performance-report-writer/SKILL.md)
