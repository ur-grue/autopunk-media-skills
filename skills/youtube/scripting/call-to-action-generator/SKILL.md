...
description: "Writes ready-to-record CTA scripts — subscribe, like, comment, sponsor read, channel promotion — matched to the channel's tone and timed to the right moment."
status: stable
category: youtube
