---
name: full-script-writer
description: "Writes a complete, word-for-word YouTube video script — from opening hook through outro — based on a title, content angle, and key talking points."
status: stable
category: youtube
subcategory: scripting
version: 1.0
eval_score: 4.4
tags: [youtube, scripting, script, long-form, writing]
---
# Full Script Writer
...
- You have a clear video concept and outline but need the actual spoken words written out
- You're a creator who scripts videos rather than speaking from bullet points
- You want a first draft to react to and edit rather than starting from a blank page
- You need to batch-produce scripts for a content sprint and want a consistent structure
...
- [ ] Transitions between sections feel natural when read aloud, not written
- [ ] Tone is consistent throughout — no sections that suddenly sound like a different writer
...
### Input
**Title:** Why Your Morning Routine Isn't Working (And What to Do Instead)
**Angle:** Most morning routine advice optimizes for discipline, not energy — and that's why it fails for most people.
**Talking points:**
1. The "discipline-based" morning routine and why it burns people out
2. The research on energy management vs. time management
3. Three questions to audit your own morning
4. A realistic 20-minute morning that actually sticks
5. Why consistency beats optimization
**Target length:** 9–10 minutes
**Tone:** Thoughtful, slightly skeptical of productivity culture, grounded in practical advice. Not preachy.
**CTA:** Comment with their current wake-up time and one thing they want to change.
...
## Known Limitations
- Scripts are written in a general educated-conversational register. For channels with highly distinctive verbal styles — heavy irony, genre-specific humor, very technical vocabulary — expect to spend meaningful time rewriting for voice after using this skill.
- This skill produces a first draft, not a final script. On-camera direction cues ([cut to], [b-roll]) are suggestions, not a production plan — supplement with the B-Roll Shot List skill for production.
- Script length estimation (130–150 words per minute) assumes a moderate speaking pace. Fast talkers will finish early; slow or pause-heavy delivery will run long. Always time a read-through before committing to a publish schedule.

## Related Skills
- [hook-generator](../../pre-production/hook-generator/SKILL.md)
- [b-roll-shot-list](../b-roll-shot-list/SKILL.md)
- [shorts-script-adapter](../shorts-script-adapter/SKILL.md)
- [chapter-timestamps](../../post-production/chapter-timestamps/SKILL.md)
