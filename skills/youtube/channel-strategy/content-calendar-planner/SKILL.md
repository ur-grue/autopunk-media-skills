...
description: "Builds a realistic 4-week content calendar for a YouTube channel, with specific video topics, formats, publishing dates, and strategic notes for each upload."
status: stable
category: youtube
...
## Related Skills
- [niche-video-idea-generator](../../pre-production/niche-video-idea-generator/SKILL.md)
- [audience-persona-builder](../audience-persona-builder/SKILL.md)
- [seo-title-optimizer](../../pre-production/seo-title-optimizer/SKILL.md)
