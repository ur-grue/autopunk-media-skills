...
description: "Generates an audience persona for the channel — who the viewer is, what they need, why they watch, and what content decisions follow."
status: stable
category: youtube
...
## Related Skills
- [content-calendar-planner](../content-calendar-planner/SKILL.md)
- [youtube-media-kit-generator](../../business/youtube-media-kit-generator/SKILL.md)
