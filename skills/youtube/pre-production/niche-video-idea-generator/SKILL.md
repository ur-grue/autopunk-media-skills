...
description: "Generates 10 video ideas for the channel's niche — each with a working title, one-sentence hook, and content angle suited to the channel's voice."
status: stable
category: youtube
...
## Related Skills
- [seo-title-optimizer](../seo-title-optimizer/SKILL.md)
- [hook-generator](../hook-generator/SKILL.md)
- [full-script-writer](../../scripting/full-script-writer/SKILL.md)
- [content-calendar-planner](../../channel-strategy/content-calendar-planner/SKILL.md)
