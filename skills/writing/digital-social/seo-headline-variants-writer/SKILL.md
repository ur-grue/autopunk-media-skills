...
description: "Produces five headline variants for a single article, each optimised for a different reader search intent — so editors can choose the version that best matches how their target audience actually searches for this topic."
status: stable
category: writing
...
## Related Skills
- [seo-meta-description-writer](../../../social-media/content/seo-meta-description-writer/SKILL.md)
- [push-notification-writer](../../../social-media/content/push-notification-writer/SKILL.md)
- [headline-generator](../../../magazine-journalism/ideation/headline-generator/SKILL.md)
