...
description: "Writes a complete YouTube video description with the first two lines optimized for the search preview, followed by a structured body that serves both the algorithm and the viewer."
status: stable
category: writing
...
## Related Skills
- [description-seo-writer](../../../youtube/post-production/description-seo-writer/SKILL.md)
- [youtube-title-writer](../youtube-title-writer/SKILL.md)
- [youtube-chapters-writer](../youtube-chapters-writer/SKILL.md)
