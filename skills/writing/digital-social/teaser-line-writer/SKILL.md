...
description: "Generates a short, compelling teaser line — one or two sentences — that earns a click through genuine story value, not misleading hype."
status: stable
category: writing
...
## Related Skills
- [twitter-post-writer](../twitter-post-writer/SKILL.md)
