...
description: "Performs and explains basic statistical calculations — percentages, percentage changes, per-capita rates, averages, medians, and ratios — from data you provide, showing the working so you can verify it and use the figures confidently in a story."
status: stable
...
## Related Skills
- [statistics-explainer](../statistics-explainer/SKILL.md) — explain a statistical concept or finding to a general audience
- [data-story-finder](../data-story-finder/SKILL.md) — identify the newsworthy story within a dataset
- [dataset-summary-brief](../dataset-summary-brief/SKILL.md) — summarize a full dataset before running specific calculations
- [methodology-explainer](../../publishing/methodology-explainer/SKILL.md) — write the methodology section explaining how calculations were performed
