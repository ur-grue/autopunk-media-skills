...
description: "Identifies unusual values, unexpected patterns, and potential stories hidden in a dataset by systematically checking for statistical outliers and contextual anomalies."
status: stable
...
- [statistics-explainer](../statistics-explainer/SKILL.md)
- [chart-type-advisor](../../visualization/chart-type-advisor/SKILL.md)
- [methodology-explainer](../../publishing/methodology-explainer/SKILL.md)
