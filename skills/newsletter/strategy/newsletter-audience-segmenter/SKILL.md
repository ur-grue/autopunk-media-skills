...
description: "Produces a practical audience segmentation brief for a newsletter, identifying 3-5 distinct subscriber groups with tailored content recommendations and messaging strategies for each segment."
status: stable
category: newsletter
...
## Related Skills
- [audience-feedback-summarizer](../audience-feedback-summarizer/SKILL.md) — summarize reader feedback to inform or validate the segmentation
- [niche-positioning-brief](../niche-positioning-brief/SKILL.md) — define the newsletter's positioning before segmenting the audience
- [content-arc-planner](../content-arc-planner/SKILL.md) — plan a content calendar tailored to the identified segments
- [paid-tier-pitch-writer](../../monetization/paid-tier-pitch-writer/SKILL.md) — write the pitch for a premium tier targeting the highest-value segment
