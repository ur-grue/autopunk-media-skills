...
description: "Writes a narration script for a documentary's animated explainer sequence — visual direction cues on each beat, ready to hand to the narrator and animation team."
status: stable
...
- [scene-breakdown-writer](../scene-breakdown-writer/SKILL.md) — plan the broader scene structure that this explainer sits within
- [narrator-voice-adapter](../narrator-voice-adapter/SKILL.md) — adapt the narration style to match a specific narrator's voice
