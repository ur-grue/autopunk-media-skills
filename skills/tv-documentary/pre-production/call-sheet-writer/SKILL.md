...
description: "Drafts a complete production call sheet for a documentary shoot day, with crew calls, talent schedules, location details, parking, weather notes, and emergency contacts — formatted for immediate distribution."
status: stable
...
## Related Skills
- [production-schedule-writer](../production-schedule-writer/SKILL.md) — plan the full multi-day shoot schedule before generating individual call sheets
- [location-scout-brief](../location-scout-brief/SKILL.md) — research and document location details before the shoot
- [equipment-list-generator](../equipment-list-generator/SKILL.md) — generate the kit list to accompany the call sheet
