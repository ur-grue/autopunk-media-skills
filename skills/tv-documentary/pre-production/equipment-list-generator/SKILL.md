...
description: "Generates a categorised equipment packing list for a documentary shoot, tailored to the production format, shooting conditions, and crew size — ready to use as a hire order, packing checklist, or kit manifest."
status: stable
...
## Related Skills
- [call-sheet-writer](../call-sheet-writer/SKILL.md) — generate the daily call sheet that references the equipment being used
- [production-budget-estimator](../production-budget-estimator/SKILL.md) — the equipment hire line in the budget should match this list
- [location-scout-brief](../location-scout-brief/SKILL.md) — location constraints (power availability, access width, noise) affect equipment choices
