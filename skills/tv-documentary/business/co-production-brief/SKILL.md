---
name: co-production-brief
description: "Writes a co-production brief for approaching a foreign broadcaster, streaming platform, or production company as a potential co-financing partner on a documentary project."
status: stable
category: tv-documentary
subcategory: business
version: 1.0
eval_score: 4.4
tags: [documentary, business, co-production, international, financing]
---
# Co-Production Brief
...
4. Addresses the partner's likely editorial question — why should their audience care about this story? — with specific territory-relevant framing if provided
5. Closes with a summary of the project's international sales potential and a clear statement of the next step being requested
...
## Quality Criteria
- [ ] The brief names the specific territory of the target partner and explains why the project is relevant to their audience or editorial priorities
- [ ] The co-production offer is specific: percentage, rights bundle, editorial involvement, and credit are stated (even if approximate)
- [ ] The financing architecture shows what is already in place — the partner can see what gap they are being asked to fill
- [ ] The international potential section is grounded in the story itself, not generic claims about documentary markets
- [ ] The next step is concrete: a meeting, a call, a market session — not "we hope to hear from you"
...
## Related Skills
- [broadcaster-pitch-writer](../broadcaster-pitch-writer/SKILL.md)
- [grant-proposal-writer](../grant-proposal-writer/SKILL.md)
