...
description: "Generates a complete documentary press kit from a synopsis and key production facts, including a long-form synopsis, short synopsis, production notes, subject profiles, and cast/crew credits block."
status: stable
category: tv-documentary
subcategory: post-production
version: 1.0
eval_score: 4.4
tags: [documentary, post-production, press-kit, publicity, distribution]
---
# Press Kit Generator
...
- A documentary is approaching its premiere, festival submission, or broadcast launch and needs a press kit for media use
- A distributor or broadcaster has requested press materials and the production needs them quickly
- You are submitting to a film festival that requires a press kit alongside the film
- You need multiple synopsis lengths for different uses (festival submission, press release, website, broadcaster catalogue)
...
- [ ] Logline captures both the emotional and factual hook of the film
...
### Input
Documentary title: The Keepers of the Reef
Runtime: 62 minutes
Director: Ana Lima
Production company: Shoreline Films
Year: 2025
Broadcast partner: Public broadcaster in Australia; international streaming TBC
Synopsis: A documentary following three generations of women from a Torres Strait Island community who have maintained and documented their coral reef knowledge for over sixty years — and who are now watching it die. Shot over two years, the film captures the first bleaching event the oldest generation has ever witnessed, a government science program that uses community knowledge, and a young woman's decision about whether to stay on the island or leave for the mainland.
Key subjects: Ivy Mabo, 84 (elder, traditional reef knowledge); Doris Mabo, 58 (Ivy's daughter, community liaison with government scientists); Coral Mabo, 23 (Doris's daughter, studying marine biology on the mainland)
Director note: "I wanted to make a film about knowledge — specifically about who gets to decide which knowledge counts. The government scientists flew in with equipment and data. Ivy had been watching this reef every day for sixty years. I wanted to show what each of them saw."
...
## Known Limitations
- The press kit is only as strong as the information provided. Thin or vague input produces generic press kit language. The Production Notes and About the Director sections in particular depend on specific, concrete details — what made this film possible, what access was unusual, what the director actually intended.
- Subject profiles use the names and roles provided by the production. The skill cannot verify biographical details or credentials — provide accurate information before generating.
- This press kit does not include visual assets (stills, posters, production photographs) — the document assumes those will be attached separately. The text is designed to accompany visual materials, not substitute for them.
